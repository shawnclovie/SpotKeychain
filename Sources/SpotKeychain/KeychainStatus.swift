...
extension KeychainStatus: RawRepresentable {

    public init(status: OSStatus) {
        if let mappedStatus = KeychainStatus(rawValue: status) {
            self = mappedStatus
        } else {
...
extension KeychainStatus: CustomNSError {
    public static let errorDomain = "KeychainAccess"
    ...
    public var errorUserInfo: [String : Any] {
        [NSLocalizedDescriptionKey: String(describing: self)]
    }
}
